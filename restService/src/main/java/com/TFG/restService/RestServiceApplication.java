...
public class RestServiceApplication {
	...
	public static LinkedList<platform.client> bddClientes = new LinkedList<platform.client>();
	public static LinkedList<platform.user> bddUsuarios = new LinkedList<platform.user>();
	public static LinkedList<platform.product> bddProductos = new LinkedList<platform.product>();
	public static LinkedList<platform.bot> bddBot = new LinkedList<platform.bot>();
	public static LinkedList<platform.box> bddBox = new LinkedList<platform.box>();
	public static LinkedList<platform.shipment> bddEnvios = new LinkedList<platform.shipment>();
	public static LinkedList<platform.purchase> bddVentas = new LinkedList<platform.purchase>();
	...
	public static void init(LinkedList<client> bddClientes, LinkedList<user> bddUsuarios, LinkedList<product> bddProductos, LinkedList<platform.bot> bddBot, LinkedList<box> bddBox, LinkedList<shipment> bddEnvios, LinkedList<platform.purchase> bddVentas) throws SQLException {
